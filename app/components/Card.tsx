  ...
  return (
    ...
    <div className="p-5">
      ...
      <p className="text-gray-600 mb-4">
        ...
        <a href={data?.eventURL} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">
          Link
        </a>
        <br />
    ...
    <div className="px-5 py-3 bg-gray-100">
      <button
        className={`w-full px-4 py-2 text-sm font-medium leading-5 text-center text-white transition-colors duration-300 ${ticketsLeft ? "bg-blue-600 hover:bg-blue-700 rounded-lg" : "bg-gray-500 hover:bg-gray-600"} focus:outline-none`}
        onClick={() => {
          handleBuyClick();
        }}
